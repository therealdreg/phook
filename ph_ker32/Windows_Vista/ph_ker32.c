...
/* 
    - ESTE MÓDULO TIENE QUE SER COMPILADO CON LA OPCIÓN -fomit-frame-pointer. 
*/
...
DLLEXPORT void _BaseThreadInitThunk ( void )
{
    JMP( FAKE_LIB, 1 );
}

DLLEXPORT void _InterlockedPushListSList ( void )
{
    JMP( FAKE_LIB, 2 );
}

DLLEXPORT void _AcquireSRWLockExclusive ( void )
{
    JMP( FAKE_LIB, 3 );
}

DLLEXPORT void _AcquireSRWLockShared ( void )
{
    JMP( FAKE_LIB, 4 );
}
...
DLLEXPORT void _AddSIDToBoundaryDescriptor ( void )
{
    JMP( FAKE_LIB, 13 );
}

DLLEXPORT void _AddVectoredContinueHandler ( void )
{
    JMP( FAKE_LIB, 14 );
}
...
DLLEXPORT void _AdjustCalendarDate ( void )
{
    JMP( FAKE_LIB, 16 );
}
...
DLLEXPORT void _AllocateUserPhysicalPagesNuma ( void )
{
    JMP( FAKE_LIB, 19 );
}

DLLEXPORT void _ApplicationRecoveryFinished ( void )
{
    JMP( FAKE_LIB, 20 );
}

DLLEXPORT void _ApplicationRecoveryInProgress ( void )
{
    JMP( FAKE_LIB, 21 );
}
...
DLLEXPORT void _BaseCheckRunApp ( void )
{
    JMP( FAKE_LIB, 29 );
}
...
DLLEXPORT void _BaseGenerateAppCompatData ( void )
{
    JMP( FAKE_LIB, 33 );
}
...
DLLEXPORT void _BaseIsAppcompatInfrastructureDisabled ( void )
{
    JMP( FAKE_LIB, 35 );
}
...
DLLEXPORT void _BasepCheckBadapp ( void )
{
    JMP( FAKE_LIB, 38 );
}
...
DLLEXPORT void _BasepFreeAppCompatData ( void )
{
    JMP( FAKE_LIB, 40 );
}
...
DLLEXPORT void _CallbackMayRunLong ( void )
{
    JMP( FAKE_LIB, 51 );
}
...
DLLEXPORT void _CancelIoEx ( void )
{
    JMP( FAKE_LIB, 54 );
}

DLLEXPORT void _CancelSynchronousIo ( void )
{
    JMP( FAKE_LIB, 55 );
}

DLLEXPORT void _CancelThreadpoolIo ( void )
{
    JMP( FAKE_LIB, 56 );
}
...
DLLEXPORT void _CheckElevation ( void )
{
    JMP( FAKE_LIB, 60 );
}

DLLEXPORT void _CheckElevationEnabled ( void )
{
    JMP( FAKE_LIB, 61 );
}

DLLEXPORT void _CheckForReadOnlyResource ( void )
{
    JMP( FAKE_LIB, 62 );
}
...
DLLEXPORT void _ClosePrivateNamespace ( void )
{
    JMP( FAKE_LIB, 70 );
}
...
DLLEXPORT void _CloseThreadpool ( void )
{
    JMP( FAKE_LIB, 72 );
}

DLLEXPORT void _CloseThreadpoolCleanupGroup ( void )
{
    JMP( FAKE_LIB, 73 );
}

DLLEXPORT void _CloseThreadpoolCleanupGroupMembers ( void )
{
    JMP( FAKE_LIB, 74 );
}

DLLEXPORT void _CloseThreadpoolIo ( void )
{
    JMP( FAKE_LIB, 75 );
}

DLLEXPORT void _CloseThreadpoolTimer ( void )
{
    JMP( FAKE_LIB, 76 );
}

DLLEXPORT void _CloseThreadpoolWait ( void )
{
    JMP( FAKE_LIB, 77 );
}

DLLEXPORT void _CloseThreadpoolWork ( void )
{
    JMP( FAKE_LIB, 78 );
}
...
DLLEXPORT void _CompareCalendarDates ( void )
{
    JMP( FAKE_LIB, 82 );
}
...
DLLEXPORT void _CompareStringEx ( void )
{
    JMP( FAKE_LIB, 85 );
}

DLLEXPORT void _CompareStringOrdinal ( void )
{
    JMP( FAKE_LIB, 86 );
}
...
DLLEXPORT void _ConvertCalDateTimeToSystemTime ( void )
{
    JMP( FAKE_LIB, 91 );
}
...
DLLEXPORT void _ConvertNLSDayOfWeekToWin32DayOfWeek ( void )
{
    JMP( FAKE_LIB, 94 );
}

DLLEXPORT void _ConvertSystemTimeToCalDateTime ( void )
{
    JMP( FAKE_LIB, 95 );
}
...
DLLEXPORT void _ConvertThreadToFiberEx ( void )
{
    JMP( FAKE_LIB, 97 );
}
...
DLLEXPORT void _CopyFileTransactedA ( void )
{
    JMP( FAKE_LIB, 101 );
}

DLLEXPORT void _CopyFileTransactedW ( void )
{
    JMP( FAKE_LIB, 102 );
}
...
DLLEXPORT void _CreateBoundaryDescriptorA ( void )
{
    JMP( FAKE_LIB, 107 );
}

DLLEXPORT void _CreateBoundaryDescriptorW ( void )
{
    JMP( FAKE_LIB, 108 );
}
...
DLLEXPORT void _CreateDirectoryTransactedA ( void )
{
    JMP( FAKE_LIB, 113 );
}

DLLEXPORT void _CreateDirectoryTransactedW ( void )
{
    JMP( FAKE_LIB, 114 );
}
...
DLLEXPORT void _CreateEventExA ( void )
{
    JMP( FAKE_LIB, 117 );
}

DLLEXPORT void _CreateEventExW ( void )
{
    JMP( FAKE_LIB, 118 );
}
...
DLLEXPORT void _CreateFileMappingNumaA ( void )
{
    JMP( FAKE_LIB, 124 );
}

DLLEXPORT void _CreateFileMappingNumaW ( void )
{
    JMP( FAKE_LIB, 125 );
}
...
DLLEXPORT void _CreateFileTransactedA ( void )
{
    JMP( FAKE_LIB, 127 );
}

DLLEXPORT void _CreateFileTransactedW ( void )
{
    JMP( FAKE_LIB, 128 );
}
...
DLLEXPORT void _CreateHardLinkTransactedA ( void )
{
    JMP( FAKE_LIB, 131 );
}

DLLEXPORT void _CreateHardLinkTransactedW ( void )
{
    JMP( FAKE_LIB, 132 );
}
...
DLLEXPORT void _CreateMutexExA ( void )
{
    JMP( FAKE_LIB, 142 );
}

DLLEXPORT void _CreateMutexExW ( void )
{
    JMP( FAKE_LIB, 143 );
}
...
DLLEXPORT void _CreatePrivateNamespaceA ( void )
{
    JMP( FAKE_LIB, 148 );
}

DLLEXPORT void _CreatePrivateNamespaceW ( void )
{
    JMP( FAKE_LIB, 149 );
}
...
DLLEXPORT void _CreateSemaphoreExA ( void )
{
    JMP( FAKE_LIB, 156 );
}

DLLEXPORT void _CreateSemaphoreExW ( void )
{
    JMP( FAKE_LIB, 157 );
}
...
DLLEXPORT void _CreateSymbolicLinkA ( void )
{
    JMP( FAKE_LIB, 160 );
}

DLLEXPORT void _CreateSymbolicLinkTransactedA ( void )
{
    JMP( FAKE_LIB, 161 );
}

DLLEXPORT void _CreateSymbolicLinkTransactedW ( void )
{
    JMP( FAKE_LIB, 162 );
}

DLLEXPORT void _CreateSymbolicLinkW ( void )
{
    JMP( FAKE_LIB, 163 );
}
...
DLLEXPORT void _CreateThreadpool ( void )
{
    JMP( FAKE_LIB, 166 );
}

DLLEXPORT void _CreateThreadpoolCleanupGroup ( void )
{
    JMP( FAKE_LIB, 167 );
}

DLLEXPORT void _CreateThreadpoolIo ( void )
{
    JMP( FAKE_LIB, 168 );
}

DLLEXPORT void _CreateThreadpoolTimer ( void )
{
    JMP( FAKE_LIB, 169 );
}

DLLEXPORT void _CreateThreadpoolWait ( void )
{
    JMP( FAKE_LIB, 170 );
}

DLLEXPORT void _CreateThreadpoolWork ( void )
{
    JMP( FAKE_LIB, 171 );
}
...
DLLEXPORT void _CreateWaitableTimerExA ( void )
{
    JMP( FAKE_LIB, 176 );
}

DLLEXPORT void _CreateWaitableTimerExW ( void )
{
    JMP( FAKE_LIB, 177 );
}
...
DLLEXPORT void _DeleteBoundaryDescriptor ( void )
{
    JMP( FAKE_LIB, 191 );
}
...
DLLEXPORT void _DeleteFileTransactedA ( void )
{
    JMP( FAKE_LIB, 195 );
}

DLLEXPORT void _DeleteFileTransactedW ( void )
{
    JMP( FAKE_LIB, 196 );
}
...
DLLEXPORT void _DeleteProcThreadAttributeList ( void )
{
    JMP( FAKE_LIB, 198 );
}
...
DLLEXPORT void _DisassociateCurrentThreadFromCallback ( void )
{
    JMP( FAKE_LIB, 206 );
}
...
DLLEXPORT void _EnumCalendarInfoExEx ( void )
{
    JMP( FAKE_LIB, 222 );
}
...
DLLEXPORT void _EnumDateFormatsExEx ( void )
{
    JMP( FAKE_LIB, 227 );
}
...
DLLEXPORT void _EnumResourceLanguagesExA ( void )
{
    JMP( FAKE_LIB, 233 );
}

DLLEXPORT void _EnumResourceLanguagesExW ( void )
{
    JMP( FAKE_LIB, 234 );
}
...
DLLEXPORT void _EnumResourceNamesExA ( void )
{
    JMP( FAKE_LIB, 237 );
}

DLLEXPORT void _EnumResourceNamesExW ( void )
{
    JMP( FAKE_LIB, 238 );
}
...
DLLEXPORT void _EnumResourceTypesExA ( void )
{
    JMP( FAKE_LIB, 241 );
}

DLLEXPORT void _EnumResourceTypesExW ( void )
{
    JMP( FAKE_LIB, 242 );
}
...
DLLEXPORT void _EnumSystemFirmwareTables ( void )
{
    JMP( FAKE_LIB, 246 );
}
...
DLLEXPORT void _EnumSystemLocalesEx ( void )
{
    JMP( FAKE_LIB, 251 );
}
...
DLLEXPORT void _EnumTimeFormatsEx ( void )
{
    JMP( FAKE_LIB, 254 );
}
...
DLLEXPORT void _FindFirstFileNameTransactedW ( void )
{
    JMP( FAKE_LIB, 290 );
}

DLLEXPORT void _FindFirstFileNameW ( void )
{
    JMP( FAKE_LIB, 291 );
}

DLLEXPORT void _FindFirstFileTransactedA ( void )
{
    JMP( FAKE_LIB, 292 );
}

DLLEXPORT void _FindFirstFileTransactedW ( void )
{
    JMP( FAKE_LIB, 293 );
}
...
DLLEXPORT void _FindFirstStreamTransactedW ( void )
{
    JMP( FAKE_LIB, 295 );
}

DLLEXPORT void _FindFirstStreamW ( void )
{
    JMP( FAKE_LIB, 296 );
}
...
DLLEXPORT void _FindNLSString ( void )
{
    JMP( FAKE_LIB, 301 );
}

DLLEXPORT void _FindNLSStringEx ( void )
{
    JMP( FAKE_LIB, 302 );
}
...
DLLEXPORT void _FindNextFileNameW ( void )
{
    JMP( FAKE_LIB, 305 );
}
...
DLLEXPORT void _FindNextStreamW ( void )
{
    JMP( FAKE_LIB, 307 );
}
...
DLLEXPORT void _FlsAlloc ( void )
{
    JMP( FAKE_LIB, 318 );
}

DLLEXPORT void _FlsFree ( void )
{
    JMP( FAKE_LIB, 319 );
}

DLLEXPORT void _FlsGetValue ( void )
{
    JMP( FAKE_LIB, 320 );
}

DLLEXPORT void _FlsSetValue ( void )
{
    JMP( FAKE_LIB, 321 );
}
...
DLLEXPORT void _FlushProcessWriteBuffers ( void )
{
    JMP( FAKE_LIB, 325 );
}
...
DLLEXPORT void _FreeLibraryWhenCallbackReturns ( void )
{
    JMP( FAKE_LIB, 336 );
}
...
DLLEXPORT void _GetApplicationRecoveryCallback ( void )
{
    JMP( FAKE_LIB, 341 );
}

DLLEXPORT void _GetApplicationRestartSettings ( void )
{
    JMP( FAKE_LIB, 342 );
}
...
DLLEXPORT void _GetCalendarDateFormat ( void )
{
    JMP( FAKE_LIB, 352 );
}

DLLEXPORT void _GetCalendarDateFormatEx ( void )
{
    JMP( FAKE_LIB, 353 );
}

DLLEXPORT void _GetCalendarDaysInMonth ( void )
{
    JMP( FAKE_LIB, 354 );
}

DLLEXPORT void _GetCalendarDifferenceInDays ( void )
{
    JMP( FAKE_LIB, 355 );
}
...
DLLEXPORT void _GetCalendarInfoEx ( void )
{
    JMP( FAKE_LIB, 357 );
}
...
DLLEXPORT void _GetCalendarMonthsInYear ( void )
{
    JMP( FAKE_LIB, 359 );
}

DLLEXPORT void _GetCalendarSupportedDateRange ( void )
{
    JMP( FAKE_LIB, 360 );
}

DLLEXPORT void _GetCalendarWeekNumber ( void )
{
    JMP( FAKE_LIB, 361 );
}
...
DLLEXPORT void _GetCompressedFileSizeTransactedA ( void )
{
    JMP( FAKE_LIB, 372 );
}

DLLEXPORT void _GetCompressedFileSizeTransactedW ( void )
{
    JMP( FAKE_LIB, 373 );
}
...
DLLEXPORT void _GetConsoleHistoryInfo ( void )
{
    JMP( FAKE_LIB, 401 );
}
...
DLLEXPORT void _GetConsoleOriginalTitleA ( void )
{
    JMP( FAKE_LIB, 409 );
}

DLLEXPORT void _GetConsoleOriginalTitleW ( void )
{
    JMP( FAKE_LIB, 410 );
}
...
DLLEXPORT void _GetConsoleScreenBufferInfoEx ( void )
{
    JMP( FAKE_LIB, 414 );
}
...
DLLEXPORT void _GetCurrencyFormatEx ( void )
{
    JMP( FAKE_LIB, 420 );
}
...
DLLEXPORT void _GetCurrentConsoleFontEx ( void )
{
    JMP( FAKE_LIB, 424 );
}
...
DLLEXPORT void _GetCurrentProcessorNumber ( void )
{
    JMP( FAKE_LIB, 429 );
}
...
DLLEXPORT void _GetDateFormatEx ( void )
{
    JMP( FAKE_LIB, 433 );
}
...
DLLEXPORT void _GetDurationFormat ( void )
{
    JMP( FAKE_LIB, 446 );
}

DLLEXPORT void _GetDurationFormatEx ( void )
{
    JMP( FAKE_LIB, 447 );
}

DLLEXPORT void _GetDynamicTimeZoneInformation ( void )
{
    JMP( FAKE_LIB, 448 );
}
...
DLLEXPORT void _GetErrorMode ( void )
{
    JMP( FAKE_LIB, 454 );
}
...
DLLEXPORT void _GetFileAttributesTransactedA ( void )
{
    JMP( FAKE_LIB, 462 );
}

DLLEXPORT void _GetFileAttributesTransactedW ( void )
{
    JMP( FAKE_LIB, 463 );
}
...
DLLEXPORT void _GetFileBandwidthReservation ( void )
{
    JMP( FAKE_LIB, 465 );
}
...
DLLEXPORT void _GetFileInformationByHandleEx ( void )
{
    JMP( FAKE_LIB, 467 );
}

DLLEXPORT void _GetFileMUIInfo ( void )
{
    JMP( FAKE_LIB, 468 );
}

DLLEXPORT void _GetFileMUIPath ( void )
{
    JMP( FAKE_LIB, 469 );
}
...
DLLEXPORT void _GetFinalPathNameByHandleA ( void )
{
    JMP( FAKE_LIB, 474 );
}

DLLEXPORT void _GetFinalPathNameByHandleW ( void )
{
    JMP( FAKE_LIB, 475 );
}
...
DLLEXPORT void _GetFullPathNameTransactedA ( void )
{
    JMP( FAKE_LIB, 479 );
}

DLLEXPORT void _GetFullPathNameTransactedW ( void )
{
    JMP( FAKE_LIB, 480 );
}
...
DLLEXPORT void _GetLargePageMinimum ( void )
{
    JMP( FAKE_LIB, 486 );
}
...
DLLEXPORT void _GetLocaleInfoEx ( void )
{
    JMP( FAKE_LIB, 491 );
}
...
DLLEXPORT void _GetLogicalProcessorInformation ( void )
{
    JMP( FAKE_LIB, 496 );
}
...
DLLEXPORT void _GetLongPathNameTransactedA ( void )
{
    JMP( FAKE_LIB, 498 );
}

DLLEXPORT void _GetLongPathNameTransactedW ( void )
{
    JMP( FAKE_LIB, 499 );
}
...
DLLEXPORT void _GetNLSVersion ( void )
{
    JMP( FAKE_LIB, 508 );
}

DLLEXPORT void _GetNLSVersionEx ( void )
{
    JMP( FAKE_LIB, 509 );
}

DLLEXPORT void _GetNamedPipeAttribute ( void )
{
    JMP( FAKE_LIB, 510 );
}

DLLEXPORT void _GetNamedPipeClientComputerNameA ( void )
{
    JMP( FAKE_LIB, 511 );
}

DLLEXPORT void _GetNamedPipeClientComputerNameW ( void )
{
    JMP( FAKE_LIB, 512 );
}

DLLEXPORT void _GetNamedPipeClientProcessId ( void )
{
    JMP( FAKE_LIB, 513 );
}

DLLEXPORT void _GetNamedPipeClientSessionId ( void )
{
    JMP( FAKE_LIB, 514 );
}
...
DLLEXPORT void _GetNamedPipeServerProcessId ( void )
{
    JMP( FAKE_LIB, 518 );
}

DLLEXPORT void _GetNamedPipeServerSessionId ( void )
{
    JMP( FAKE_LIB, 519 );
}
...
DLLEXPORT void _GetNumaProximityNode ( void )
{
    JMP( FAKE_LIB, 526 );
}
...
DLLEXPORT void _GetNumberFormatEx ( void )
{
    JMP( FAKE_LIB, 528 );
}
...
DLLEXPORT void _GetProcessIdOfThread ( void )
{
    JMP( FAKE_LIB, 552 );
}
...
DLLEXPORT void _GetProcessWorkingSetSizeEx ( void )
{
    JMP( FAKE_LIB, 559 );
}

DLLEXPORT void _GetProductInfo ( void )
{
    JMP( FAKE_LIB, 560 );
}
...
DLLEXPORT void _GetQueuedCompletionStatusEx ( void )
{
    JMP( FAKE_LIB, 568 );
}
...
DLLEXPORT void _GetStringScripts ( void )
{
    JMP( FAKE_LIB, 574 );
}
...
DLLEXPORT void _GetSystemDefaultLocaleName ( void )
{
    JMP( FAKE_LIB, 581 );
}
...
DLLEXPORT void _GetSystemFileCacheSize ( void )
{
    JMP( FAKE_LIB, 585 );
}

DLLEXPORT void _GetSystemFirmwareTable ( void )
{
    JMP( FAKE_LIB, 586 );
}
...
DLLEXPORT void _GetSystemPreferredUILanguages ( void )
{
    JMP( FAKE_LIB, 589 );
}
...
DLLEXPORT void _GetThreadId ( void )
{
    JMP( FAKE_LIB, 608 );
}
...
DLLEXPORT void _GetThreadPreferredUILanguages ( void )
{
    JMP( FAKE_LIB, 610 );
}
...
DLLEXPORT void _GetThreadUILanguage ( void )
{
    JMP( FAKE_LIB, 615 );
}

DLLEXPORT void _GetTickCount64 ( void )
{
    JMP( FAKE_LIB, 616 );
}
...
DLLEXPORT void _GetTimeFormatEx ( void )
{
    JMP( FAKE_LIB, 619 );
}
...
DLLEXPORT void _GetUILanguageInfo ( void )
{
    JMP( FAKE_LIB, 622 );
}
...
DLLEXPORT void _GetUserDefaultLocaleName ( void )
{
    JMP( FAKE_LIB, 625 );
}
...
DLLEXPORT void _GetUserPreferredUILanguages ( void )
{
    JMP( FAKE_LIB, 628 );
}
...
DLLEXPORT void _GetVolumeInformationByHandleW ( void )
{
    JMP( FAKE_LIB, 634 );
}
...
DLLEXPORT void _IdnToAscii ( void )
{
    JMP( FAKE_LIB, 685 );
}

DLLEXPORT void _IdnToNameprepUnicode ( void )
{
    JMP( FAKE_LIB, 686 );
}

DLLEXPORT void _IdnToUnicode ( void )
{
    JMP( FAKE_LIB, 687 );
}
...
DLLEXPORT void _InitOnceBeginInitialize ( void )
{
    JMP( FAKE_LIB, 689 );
}

DLLEXPORT void _InitOnceComplete ( void )
{
    JMP( FAKE_LIB, 690 );
}

DLLEXPORT void _InitOnceExecuteOnce ( void )
{
    JMP( FAKE_LIB, 691 );
}

DLLEXPORT void _InitOnceInitialize ( void )
{
    JMP( FAKE_LIB, 692 );
}

DLLEXPORT void _InitializeConditionVariable ( void )
{
    JMP( FAKE_LIB, 693 );
}
...
DLLEXPORT void _InitializeCriticalSectionEx ( void )
{
    JMP( FAKE_LIB, 696 );
}

DLLEXPORT void _InitializeProcThreadAttributeList ( void )
{
    JMP( FAKE_LIB, 697 );
}
...
DLLEXPORT void _InitializeSRWLock ( void )
{
    JMP( FAKE_LIB, 699 );
}

DLLEXPORT void _InterlockedCompareExchange64 ( void )
{
    JMP( FAKE_LIB, 700 );
}
...
DLLEXPORT void _IsCalendarLeapDay ( void )
{
    JMP( FAKE_LIB, 717 );
}

DLLEXPORT void _IsCalendarLeapMonth ( void )
{
    JMP( FAKE_LIB, 718 );
}

DLLEXPORT void _IsCalendarLeapYear ( void )
{
    JMP( FAKE_LIB, 719 );
}
...
DLLEXPORT void _IsNLSDefinedString ( void )
{
    JMP( FAKE_LIB, 723 );
}

DLLEXPORT void _IsNormalizedString ( void )
{
    JMP( FAKE_LIB, 724 );
}
...
DLLEXPORT void _IsThreadAFiber ( void )
{
    JMP( FAKE_LIB, 728 );
}

DLLEXPORT void _IsThreadpoolTimerSet ( void )
{
    JMP( FAKE_LIB, 729 );
}

DLLEXPORT void _IsTimeZoneRedirectionEnabled ( void )
{
    JMP( FAKE_LIB, 730 );
}

DLLEXPORT void _IsValidCalDateTime ( void )
{
    JMP( FAKE_LIB, 731 );
}
...
DLLEXPORT void _IsValidLocaleName ( void )
{
    JMP( FAKE_LIB, 735 );
}
...
DLLEXPORT void _LCIDToLocaleName ( void )
{
    JMP( FAKE_LIB, 737 );
}
...
DLLEXPORT void _LCMapStringEx ( void )
{
    JMP( FAKE_LIB, 739 );
}
...
DLLEXPORT void _LeaveCriticalSectionWhenCallbackReturns ( void )
{
    JMP( FAKE_LIB, 753 );
}
...
DLLEXPORT void _LoadStringBaseExW ( void )
{
    JMP( FAKE_LIB, 760 );
}

DLLEXPORT void _LoadStringBaseW ( void )
{
    JMP( FAKE_LIB, 761 );
}
...
DLLEXPORT void _LocaleNameToLCID ( void )
{
    JMP( FAKE_LIB, 773 );
}
...
DLLEXPORT void _MapViewOfFileExNuma ( void )
{
    JMP( FAKE_LIB, 781 );
}
...
DLLEXPORT void _MoveFileTransactedA ( void )
{
    JMP( FAKE_LIB, 789 );
}

DLLEXPORT void _MoveFileTransactedW ( void )
{
    JMP( FAKE_LIB, 790 );
}
...
DLLEXPORT void _NeedCurrentDirectoryForExePathA ( void )
{
    JMP( FAKE_LIB, 796 );
}

DLLEXPORT void _NeedCurrentDirectoryForExePathW ( void )
{
    JMP( FAKE_LIB, 797 );
}

DLLEXPORT void _NlsCheckPolicy ( void )
{
    JMP( FAKE_LIB, 798 );
}
...
DLLEXPORT void _NlsEventDataDescCreate ( void )
{
    JMP( FAKE_LIB, 800 );
}
...
DLLEXPORT void _NlsUpdateLocale ( void )
{
    JMP( FAKE_LIB, 802 );
}

DLLEXPORT void _NlsUpdateSystemLocale ( void )
{
    JMP( FAKE_LIB, 803 );
}

DLLEXPORT void _NlsWriteEtwEvent ( void )
{
    JMP( FAKE_LIB, 804 );
}

DLLEXPORT void _NormalizeString ( void )
{
    JMP( FAKE_LIB, 805 );
}

DLLEXPORT void _NotifyUILanguageChange ( void )
{
    JMP( FAKE_LIB, 806 );
}
...
DLLEXPORT void _OpenFileById ( void )
{
    JMP( FAKE_LIB, 811 );
}
...
DLLEXPORT void _OpenPrivateNamespaceA ( void )
{
    JMP( FAKE_LIB, 818 );
}

DLLEXPORT void _OpenPrivateNamespaceW ( void )
{
    JMP( FAKE_LIB, 819 );
}
...
DLLEXPORT void _QueryActCtxSettingsW ( void )
{
    JMP( FAKE_LIB, 843 );
}
...
DLLEXPORT void _QueryFullProcessImageNameA ( void )
{
    JMP( FAKE_LIB, 848 );
}

DLLEXPORT void _QueryFullProcessImageNameW ( void )
{
    JMP( FAKE_LIB, 849 );
}

DLLEXPORT void _QueryIdleProcessorCycleTime ( void )
{
    JMP( FAKE_LIB, 850 );
}
...
DLLEXPORT void _QueryProcessCycleTime ( void )
{
    JMP( FAKE_LIB, 855 );
}

DLLEXPORT void _QueryThreadCycleTime ( void )
{
    JMP( FAKE_LIB, 856 );
}
...
DLLEXPORT void _ReOpenFile ( void )
{
    JMP( FAKE_LIB, 860 );
}
...
DLLEXPORT void _RegisterApplicationRecoveryCallback ( void )
{
    JMP( FAKE_LIB, 877 );
}

DLLEXPORT void _RegisterApplicationRestart ( void )
{
    JMP( FAKE_LIB, 878 );
}
...
DLLEXPORT void _ReleaseMutexWhenCallbackReturns ( void )
{
    JMP( FAKE_LIB, 889 );
}

DLLEXPORT void _ReleaseSRWLockExclusive ( void )
{
    JMP( FAKE_LIB, 890 );
}

DLLEXPORT void _ReleaseSRWLockShared ( void )
{
    JMP( FAKE_LIB, 891 );
}
...
DLLEXPORT void _ReleaseSemaphoreWhenCallbackReturns ( void )
{
    JMP( FAKE_LIB, 893 );
}
...
DLLEXPORT void _RemoveDirectoryTransactedA ( void )
{
    JMP( FAKE_LIB, 895 );
}

DLLEXPORT void _RemoveDirectoryTransactedW ( void )
{
    JMP( FAKE_LIB, 896 );
}
...
DLLEXPORT void _RemoveVectoredContinueHandler ( void )
{
    JMP( FAKE_LIB, 900 );
}
...
DLLEXPORT void _SetConsoleHistoryInfo ( void )
{
    JMP( FAKE_LIB, 944 );
}
...
DLLEXPORT void _SetConsoleScreenBufferInfoEx ( void )
{
    JMP( FAKE_LIB, 959 );
}
...
DLLEXPORT void _SetCurrentConsoleFontEx ( void )
{
    JMP( FAKE_LIB, 966 );
}
...
DLLEXPORT void _SetDynamicTimeZoneInformation ( void )
{
    JMP( FAKE_LIB, 973 );
}
...
DLLEXPORT void _SetEnvironmentStringsA ( void )
{
    JMP( FAKE_LIB, 975 );
}

DLLEXPORT void _SetEnvironmentStringsW ( void )
{
    JMP( FAKE_LIB, 976 );
}
...
DLLEXPORT void _SetEventWhenCallbackReturns ( void )
{
    JMP( FAKE_LIB, 981 );
}
...
DLLEXPORT void _SetFileAttributesTransactedA ( void )
{
    JMP( FAKE_LIB, 985 );
}

DLLEXPORT void _SetFileAttributesTransactedW ( void )
{
    JMP( FAKE_LIB, 986 );
}
...
DLLEXPORT void _SetFileBandwidthReservation ( void )
{
    JMP( FAKE_LIB, 988 );
}

DLLEXPORT void _SetFileCompletionNotificationModes ( void )
{
    JMP( FAKE_LIB, 989 );
}

DLLEXPORT void _SetFileInformationByHandle ( void )
{
    JMP( FAKE_LIB, 990 );
}

DLLEXPORT void _SetFileIoOverlappedRange ( void )
{
    JMP( FAKE_LIB, 991 );
}
...
DLLEXPORT void _SetNamedPipeAttribute ( void )
{
    JMP( FAKE_LIB, 1013 );
}
...
DLLEXPORT void _SetProcessWorkingSetSizeEx ( void )
{
    JMP( FAKE_LIB, 1020 );
}
...
DLLEXPORT void _SetStdHandleEx ( void )
{
    JMP( FAKE_LIB, 1022 );
}

DLLEXPORT void _SetSystemFileCacheSize ( void )
{
    JMP( FAKE_LIB, 1023 );
}
...
DLLEXPORT void _SetThreadPreferredUILanguages ( void )
{
    JMP( FAKE_LIB, 1035 );
}
...
DLLEXPORT void _SetThreadStackGuarantee ( void )
{
    JMP( FAKE_LIB, 1038 );
}
...
DLLEXPORT void _SetThreadpoolThreadMaximum ( void )
{
    JMP( FAKE_LIB, 1040 );
}

DLLEXPORT void _SetThreadpoolThreadMinimum ( void )
{
    JMP( FAKE_LIB, 1041 );
}

DLLEXPORT void _SetThreadpoolTimer ( void )
{
    JMP( FAKE_LIB, 1042 );
}

DLLEXPORT void _SetThreadpoolWait ( void )
{
    JMP( FAKE_LIB, 1043 );
}
...
DLLEXPORT void _SleepConditionVariableCS ( void )
{
    JMP( FAKE_LIB, 1059 );
}

DLLEXPORT void _SleepConditionVariableSRW ( void )
{
    JMP( FAKE_LIB, 1060 );
}
...
DLLEXPORT void _StartThreadpoolIo ( void )
{
    JMP( FAKE_LIB, 1062 );
}

DLLEXPORT void _SubmitThreadpoolWork ( void )
{
    JMP( FAKE_LIB, 1063 );
}
...
DLLEXPORT void _TrySubmitThreadpoolCallback ( void )
{
    JMP( FAKE_LIB, 1083 );
}
...
DLLEXPORT void _UnregisterApplicationRecoveryCallback ( void )
{
    JMP( FAKE_LIB, 1091 );
}

DLLEXPORT void _UnregisterApplicationRestart ( void )
{
    JMP( FAKE_LIB, 1092 );
}
...
DLLEXPORT void _UpdateCalendarDayOfWeek ( void )
{
    JMP( FAKE_LIB, 1096 );
}

DLLEXPORT void _UpdateProcThreadAttribute ( void )
{
    JMP( FAKE_LIB, 1097 );
}
...
DLLEXPORT void _VerifyScripts ( void )
{
    JMP( FAKE_LIB, 1106 );
}
...
DLLEXPORT void _VirtualAllocExNuma ( void )
{
    JMP( FAKE_LIB, 1111 );
}
...
DLLEXPORT void _WaitForThreadpoolIoCallbacks ( void )
{
    JMP( FAKE_LIB, 1127 );
}

DLLEXPORT void _WaitForThreadpoolTimerCallbacks ( void )
{
    JMP( FAKE_LIB, 1128 );
}

DLLEXPORT void _WaitForThreadpoolWaitCallbacks ( void )
{
    JMP( FAKE_LIB, 1129 );
}

DLLEXPORT void _WaitForThreadpoolWorkCallbacks ( void )
{
    JMP( FAKE_LIB, 1130 );
}
...
DLLEXPORT void _WakeAllConditionVariable ( void )
{
    JMP( FAKE_LIB, 1133 );
}

DLLEXPORT void _WakeConditionVariable ( void )
{
    JMP( FAKE_LIB, 1134 );
}

DLLEXPORT void _WerGetFlags ( void )
{
    JMP( FAKE_LIB, 1135 );
}

DLLEXPORT void _WerRegisterFile ( void )
{
    JMP( FAKE_LIB, 1136 );
}

DLLEXPORT void _WerRegisterMemoryBlock ( void )
{
    JMP( FAKE_LIB, 1137 );
}

DLLEXPORT void _WerSetFlags ( void )
{
    JMP( FAKE_LIB, 1138 );
}

DLLEXPORT void _WerUnregisterFile ( void )
{
    JMP( FAKE_LIB, 1139 );
}

DLLEXPORT void _WerUnregisterMemoryBlock ( void )
{
    JMP( FAKE_LIB, 1140 );
}

DLLEXPORT void _WerpCleanupMessageMapping ( void )
{
    JMP( FAKE_LIB, 1141 );
}

DLLEXPORT void _WerpInitiateRemoteRecovery ( void )
{
    JMP( FAKE_LIB, 1142 );
}

DLLEXPORT void _WerpNotifyLoadStringResource ( void )
{
    JMP( FAKE_LIB, 1143 );
}

DLLEXPORT void _WerpNotifyLoadStringResourceEx ( void )
{
    JMP( FAKE_LIB, 1144 );
}

DLLEXPORT void _WerpNotifyUseStringResource ( void )
{
    JMP( FAKE_LIB, 1145 );
}

DLLEXPORT void _WerpStringLookup ( void )
{
    JMP( FAKE_LIB, 1146 );
}
...
DLLEXPORT void _Wow64DisableWow64FsRedirection ( void )
{
    JMP( FAKE_LIB, 1149 );
}

DLLEXPORT void _Wow64EnableWow64FsRedirection ( void )
{
    JMP( FAKE_LIB, 1150 );
}

DLLEXPORT void _Wow64GetThreadContext ( void )
{
    JMP( FAKE_LIB, 1151 );
}

DLLEXPORT void _Wow64RevertWow64FsRedirection ( void )
{
    JMP( FAKE_LIB, 1152 );
}

DLLEXPORT void _Wow64SetThreadContext ( void )
{
    JMP( FAKE_LIB, 1153 );
}

DLLEXPORT void _Wow64SuspendThread ( void )
{
    JMP( FAKE_LIB, 1154 );
}
